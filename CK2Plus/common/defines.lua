...
NDiplomacy = {
	...
	VASSAL_LIMIT_DUKE_MULT = 5.0, 				-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_KING_MULT = 10.0, 				-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_EMPEROR_MULT = 15.0, 			-- Extra Vassal Limit from the ruler's rank
	VASSAL_LIMIT_GREAT_DUKE_BONUS = 2.0, 		-- Extra Vassal Limit for Dukes with more than one Duchy
	VASSAL_LIMIT_DIPLOMACY_MULT = 0.3,			-- Extra Vasal Limit from ruler and spouse diplomacy
	VASSAL_LIMIT_TRIBAL_BONUS = -5,				-- All rulers with tribal holdings as their capital have smaller demesnes
	VASSAL_LIMIT_DECADENCE_MULTIPLIER = 0.50,	-- Negative modifier, multiplied with the current decadence.
	...
	MUSLIM_CROWN_LAW_CHANGE_PIETY_COST = 200,	-- Piety cost for Muslims when changing Crown laws
	INTER_MUSLIM_WAR_MONTHLY_PIETY_COST = 4,  	-- Monthly Piety cost for Muslims who are primary attackers against a ruler of the same religion (not civil wars)
	...
	MIN_PREP_INV_TARGET_HOLDINGS = 12,			-- The target must control at least this many holdings within the target kingdom to be a valid prepared invasion target
...
NDecadence = {
	BASE_EMPEROR_GAIN = 0.40,
	BASE_KING_GAIN = 0.30,
	BASE_DUKE_GAIN = 0.20,
	BASE_COUNT_GAIN = 0.12,
	BASE_BARON_GAIN = 0.08,
	BASE_UNLANDED_GAIN = 0.05,
...
NMilitary = {
	...
	LOW_DECADENCE_MORALE_MOD = 0.20,				-- Extra Morale defence when at 0% decadence
	...
	MAX_RIVER_MOVEMENT_FORT_LEVEL = 15.0,
